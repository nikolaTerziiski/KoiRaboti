-- Canonical fresh-install schema for the current KoiRaboti app.
--
-- This file combines:
--   1. supabase/legacy/schema.sql
--   2. supabase/legacy/patch_expense_bot_tables.sql
--   3. supabase/legacy/patch_restaurant_expense_categories.sql
--
-- Use this for new projects and backup sandboxes.
-- Historical patch files are kept in the repo only for legacy upgrade reference.
